...
class ReviewServiceTest {
    ...
    public void init() {
        ...
        pokemon = Pokemon.builder().name("senera").type("electric").build();
        pokemonDto = PokemonDto.builder().name("Senera").type("electric").build();
    ...
    @Test
    public void ReviewService_CreateReview_ReturnNewReview() {
    ...
    @Test
    public void ReviewService_GetReviewsByPokemonId_ReturnSpecifiedReview() {
    ...
    @Test
    public void ReviewService_GetReviewById_ReturnReview() {
        ...
        Assertions.assertThat(review.getStars()).isEqualTo(5);
    }
